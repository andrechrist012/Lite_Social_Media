            ...
            <div class="card card-widget">
              <div class="card-header">
                <div class="user-block">
                  ...
                  <span class="username"><a href="/profile/{{$value->user->id}}">{{$value->user->profile->first_name}} {{$value->user->profile->last_name}}</span></a>
                ...
                @elseif (Auth::user()->email == 'admin@skypost.com')
                  <form action="/post/{{$value->id}}" method="POST" style="float: right;">
                    @csrf
                    @method('DELETE')
                    <input type="submit" class="btn btn-danger" value="Delete">
