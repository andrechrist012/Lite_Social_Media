    ...
    <section id="cover" class="container">
      <div class="jumbotron  mb-0 pb-2" style="background-color: white; display: flex; align-items: center; justify-content: space-around;">
        <div style="display: flex; flex-direction: column; align-items: center;">
          <img src="{{asset('image-upload/'.$profile->thumbnail_url)}}" class="rounded-circle border" alt="..." width="200" height="200">
        ...
        <div class="col-md-4 rounded  ml-3">
            <h3>Intro</h3>
            <hr class="border">
            <p><i class="fas fa-gift"></i>  {{$profile->date_of_birth}}</p>
            <p><i class="fas fa-map-marker-alt"></i>  {{$profile->address}}</p>
            <p><i class="fas fa-pencil-alt"></i> Bio: <br> {{$profile->bio}}</p>
        </div>
      </div>
      <div class="jumbotron my-0 py-0" style="background-color: rgb(59, 121, 172);">
        <div class="d-flex bd-highlight mb-3">
          ...
          <div class="ml-auto p-2 bd-highlight">
            <a href="profile/{{$profile->user_id}}/edit"><button type="button" class="btn btn-default" style="color: rgb(59, 121, 172);">Edit Profile</button></a>
          </div>
        <div>
      </div>
    </section>
